module "elb_controller_irsa_role" {
  ...
  policy_name_prefix = var.elb_controller_policy_prefix_enable_override ? var.elb_controller_policy_prefix_override_name : elb_controller_policy_default_prefix
